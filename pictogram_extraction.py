    ...
    for image_file in image_files:
        ...
        for i, box in enumerate(results[0].boxes):
            ...
            if class_label in seen_classes:
                continue  # Skip this class if already saved anywhere

            if class_label != "unknown" and confidence_score >= 0.5:
                base_name = os.path.splitext(image_file)[0]
                output_path = os.path.join(output_folder, f"{base_name}_pictogram_{class_label}.png")
